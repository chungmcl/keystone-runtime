...
SRCS = aes.c sha256.c boot.c interrupt.c printf.c syscall.c string.c timing_buff.c linux_wrap.c io_wrap.c net_wrap.c rt_util.c mm.c env.c freemem.c paging.c sbi.c merkle.c page_swap.c vm.c
ASM_SRCS = entry.S
RUNTIME = eyrie-rt
